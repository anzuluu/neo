        ...
        if (args[0]) {
            ...
            if (comando) {
                let embed = new Discord.EmbedBuilder()
                    ...
                    .setFooter({ text: `© desarrollado por Doki#6108 | 2022`, iconURL: `https://images-ext-2.discordapp.net/external/SmQw3BNZQ3y8-um7eLPdnRyMDbn7ddK3nEKXr4L8RyU/https/cdn.discordapp.com/icons/1001265259513909338/57cc1e0d2f1075ddbdf146be03b6e905.webp` })
            ...
            .setColor(client.color)
            .setDescription(`Bot Multifuncional en desarrollo por \`Doki#6108\``)
            ...
            .addFields([{name: `📈 **__ESTADÍSTICAS__**`, value: `⚙ **${client.commands.size} Comandos**\n📁 en **${client.guilds.cache.size} Servidores**\n📶 **\`${client.ws.ping}ms\` Ping**\n👤 desarrollado por **[Doki#6108](https://discord.gg/QMRxC5AP)**`}], )
            .addFields([{name: `✍ **__Bot Soporte__**`, value: `[\`Link Del Servidor!\`](https://discord.gg/BJgydtK2fe)`}], )
            .setThumbnail(message.guild.iconURL({ dynamic: true }))
            .setFooter({ text: `Página 1 / ${categorias.length+1}\n© desarrollado por Doki#6108 | 2022`, iconURL: `https://images-ext-2.discordapp.net/external/SmQw3BNZQ3y8-um7eLPdnRyMDbn7ddK3nEKXr4L8RyU/https/cdn.discordapp.com/icons/1001265259513909338/57cc1e0d2f1075ddbdf146be03b6e905.webp` })
            ...
            categorias.map((categoria, index) => {
                ...
                let embed = new Discord.EmbedBuilder()
                    ...
                    .setThumbnail(message.guild.iconURL({ dynamic: true }))
                    .setDescription(comandos_de_categoria.length >= 1 ? `>>> *${comandos_de_categoria.map(comando => `\`${comando.replace(/.js/, "")}\``).join(" - ")}*` : `>>> *Todavía no hay comandos en esta categoría...*`)
                    .setFooter({ text: `Página ${index+2} / ${categorias.length+1}\n© desarrollado por Doki#6108 | 2022`, iconURL: `https://cdn.discordapp.com/avatars/282942681980862474/7ff4f4ae92af5feb0d258a71cdb0b060.png?size=4096` })
            ...
            collector.on("collect", async (interaccion) => {
                if (interaccion.isButton()) {
                    ...
                    for (const seleccionado of interaccion.values) {
                        ...
                        .setThumbnail(message.guild.iconURL({ dynamic: true }))
                        .setDescription(comandos_de_categoria.length >= 1 ? `>>> *${comandos_de_categoria.map(comando => `\`${comando.replace(/.js/, "")}\``).join(" - ")}*` : `>>> *Todavía no hay comandos en esta categoría...*`)
                        .setFooter({text: `© desarrollado por Doki#6108 | 2022`, iconURL: `https://cdn.discordapp.com/avatars/282942681980862474/7ff4f4ae92af5feb0d258a71cdb0b060.png?size=4096` })
